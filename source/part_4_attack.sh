...
tcpdump -i eth0 -w "part4_syn_flood.pcap" &
...
tcpdump -i eth0 -w "part4_udp_flood.pcap" &
...
tcpdump -i eth0 -w "part4_xmas_scan.pcap" &
nmap -sX $victim_ip
sleep 2
kill $!
...
tcpdump -i eth0 -w "part4_ping_of_death.pcap" &
...
tcpdump -i eth0 -w "part4_buffer_overflow.pcap" &
