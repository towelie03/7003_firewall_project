...
tcpdump -i eth0 -w "part2_syn_flood.pcap" &
...
tcpdump -i eth0 -w "part2_udp_flood.pcap" &
...
tcpdump -i eth0 -w "part2_xmas_scan.pcap" &
nmap -sX $victim_ip
sleep 2
kill $!
...
tcpdump -i eth0 -w "part2_ping_of_death.pcap" &
...
tcpdump -i eth0 -w "part2_buffer_overflow.pcap" &
