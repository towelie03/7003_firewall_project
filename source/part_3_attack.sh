...
tcpdump -i any -w "part3_syn_flood_$timestamp.pcap" &
...
tcpdump -i any -w "part3_udp_flood_$timestamp.pcap" &
...
tcpdump -i any -w "part3_xmas_scan_$timestamp.pcap" &
nmap -sX $victim_ip
sleep 2
kill $!
...
tcpdump -i any -w "part3_ping_of_death_$timestamp.pcap" &
...
tcpdump -i any -w "part3_buffer_overflow_$timestamp.pcap" &
