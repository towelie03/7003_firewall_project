...
tcpdump -i eth0 -w "part1_syn_flood.pcap" &
...
tcpdump -i eth0 -w "part1_udp_flood.pcap" &
...
tcpdump -i eth0 -w "part1_xmas_scan.pcap" &
nmap -sX $victim_ip
sleep 2
kill $!
...
tcpdump -i eth0 -w "part1_ping_of_death.pcap" &
...
tcpdump -i eth0 -w "part1_buffer_overflow.pcap" &
